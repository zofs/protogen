...
func (x *ID) Reset() {
	*x = ID{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dtopb_param_proto_msgTypes[0]
...
func (*ID) Descriptor() ([]byte, []int) {
	return file_dtopb_param_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_dtopb_param_proto_rawDescOnce sync.Once
	file_dtopb_param_proto_rawDescData = file_dtopb_param_proto_rawDesc
)

func file_dtopb_param_proto_rawDescGZIP() []byte {
	file_dtopb_param_proto_rawDescOnce.Do(func() {
		file_dtopb_param_proto_rawDescData = protoimpl.X.CompressGZIP(file_dtopb_param_proto_rawDescData)
	})
...
func init() { file_dtopb_param_proto_init() }
func file_dtopb_param_proto_init() {
	if File_dtopb_param_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_dtopb_param_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ID); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dtopb_param_proto_goTypes,
		DependencyIndexes: file_dtopb_param_proto_depIdxs,
		MessageInfos:      file_dtopb_param_proto_msgTypes,
	}.Build()
	File_dtopb_param_proto = out.File
	file_dtopb_param_proto_rawDesc = nil
	file_dtopb_param_proto_goTypes = nil
	file_dtopb_param_proto_depIdxs = nil
}
